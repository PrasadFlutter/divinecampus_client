...
import 'package:lawexample/pages/Quotation/Symbolbytopic.dart';

class SymbolScreen extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return SymbolScreenState();
  }
}

class SymbolScreenState extends State<SymbolScreen> {
  List<SymbolModel> symbollistResponse = [];
  ...
  callapi() async {
    symbollistResponse = await ApiManager().GetSymbolDetails();
    setState(() {});
  }
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: Padding(
          ...
          child: symbollistResponse.isNotEmpty
              ? ListView.builder(
                    ...
                    return GestureDetector(
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => SymbolDescription(
                              SymbolTopic: symbollistResponse[i].SymbolCat,
                            ),
                          ),
                        );
                      },
                              ...
                              Row(
                                ...
                                children: [
                                  Padding(
                                    ...
                                    child: Text(
                                      symbollistResponse[i].SymbolCat,
                                      style: TextStyle(
                                        fontFamily: 'Jost',
                                        fontSize: 14,
                                        color: Colors.black,
                                  ...
                                  Text(
                                    "(" +
                                        symbollistResponse[i].TotalCount +
                                        ") ",
                                    style: TextStyle(
                                      fontFamily: 'Jost',
                                      fontSize: 13,
