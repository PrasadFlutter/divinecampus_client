...
class DetailedebooksTopicPage extends StatefulWidget {
  ...
  State<StatefulWidget> createState() {
    return DetailedebooksTopicPageState();
  }
}

class DetailedebooksTopicPageState extends State<DetailedebooksTopicPage> {
