...
List<SymbolDescriptionBytopic> SymbolDescriptionBytopiclFromJson(String str) =>
    List<SymbolDescriptionBytopic>.from(
        json.decode(str).map((x) => SymbolDescriptionBytopic.fromJson(x)));

String SymbolDescriptionBytopicToJson(List<SymbolDescriptionBytopic> data) =>
    json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
class SymbolDescriptionBytopic {
  int? symbolID;
  String? symbolCode;
  String? symbolName;
  String? symbolCat;
  ...
  SymbolDescriptionBytopic.fromJson(Map<String, dynamic> json) {
